...
ISM330DHCX_ACC_Drv_t ISM330DHCX_ACC_Driver =
{
  ...
  ISM330DHCX_ACC_Enable_Free_Fall_Detection,
  ISM330DHCX_ACC_Disable_Free_Fall_Detection,
  ISM330DHCX_ACC_Set_Free_Fall_Threshold,
  ISM330DHCX_ACC_Set_Free_Fall_Duration,
  ISM330DHCX_ACC_Get_Event_Status,
};
