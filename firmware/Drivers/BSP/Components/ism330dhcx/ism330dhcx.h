...
typedef struct
{
  ...
  int32_t (*EnableFreeFallDetection)(ISM330DHCX_Object_t *, ISM330DHCX_SensorIntPin_t);
  int32_t (*DisableFreeFallDetection)(ISM330DHCX_Object_t *);
  int32_t (*SetFreeFallThreshold)(ISM330DHCX_Object_t *, uint8_t);
  int32_t (*SetFreeFallDuration)(ISM330DHCX_Object_t *, uint8_t);
  int32_t (*GetEventStatus)(ISM330DHCX_Object_t *, ISM330DHCX_Event_Status_t *);
